	...
	public static void main(String[] args) {
		...
		while (value) {
			...
			case 3:
				...
				Date date = new Date();
				Transaction transaction = new Transaction(transId, accNo, 0, depositAmount, "deposit", date,
						finalAmount);
			...
			case 4:
				...
				Date date1 = new Date();
				Transaction transaction1 = new Transaction(transId1, accNo, 0, withdrawAmount, "withdraw", date1,
						finalAmount1);
			...
			case 5:
				...
				Transaction transaction2 = new Transaction(transId2, accNoFrom, accNoTo, transferAmount,
						"fund Transfer", date2, fromAccFinalBalance);
